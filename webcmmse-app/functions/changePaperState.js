...
module.exports = (changePaperState) => {
    ...
    const mailOptions = {
        ...
        <p>Your paper state has been changed to <strong>${changePaperState.state}</strong>.</p><br/>
        <p>Paper: ${changePaperState.title}.</p><br/>
        <p>Document: ${changePaperState.url}.</p><br/>
        <p>First author: ${changePaperState.author}, ${changePaperState.authorEmail}.</p><br/>
        <p>Sincerely,<br/>
